...
if($rep_type == ""){
	...
	$strSQL = "SELECT id,prefix,firstname,lastname,xmo,room,sub_code," ;
	$strSQL = $strSQL . " sub_name,full_hour,lost_hour,getPercent," ;
	$strSQL = $strSQL . " teacher_name FROM noexam_report WHERE 1 " ;
	$strSQL = $strSQL . " FROM noexam_report ";
	$strSQL = $strSQL . " Where xmo = $rep_type ";
	$strSQL = $strSQL . " Order by room,ordinal ";	
}

/*	if ($rep_type == "by_exittype"){
